...
```{r summary1, echo=FALSE, message=FALSE, fig.width=12, fig.height=6, warning=FALSE}
...
```{r summary2, echo=FALSE, message=FALSE, fig.width=12, fig.height=6, warning=FALSE}
